 ...
 * @param {String} token            User token to identify against the PEP Proxies (optional).
 */
async function sendUpdateValueNgsiLD(entityName, originMeasures, originTypeInformation, token, callback) {
    ...
    const url = '/ngsi-ld/v1/entities/urn:ngsi-ld:multiSensor:bme680/attrs';
    options = await NGSIUtils.createRequestObject(url, originTypeInformation, token)
